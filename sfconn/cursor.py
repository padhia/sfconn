...
class Cursor(SnowflakeCursor):
    ...
    def run_query(self, rec: Callable[..., T] | type[T], sql: str, params: Params = None, *, select: list[str] | None = None) -> Iterable[T]:
    ...
    def run_query1_opt(self, rec: Callable[..., T] | type[T], sql: str, params: Params = None, *, select: list[str] | None = None) -> T | None:
    ...
    def run_query1(self, rec: Callable[..., T] | type[T], sql: str, params: Params = None, *, select: list[str] | None = None) -> T:
        """execute a SELECT statement, return the first row mapped using the provided function
